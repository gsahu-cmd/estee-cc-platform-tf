...
def group_mapping_stack_dir(repo_root: Path, platform_environment: str, properties: dict[str, str]) -> Path:
	"""Return the configured group-mapping Terraform stack directory."""
